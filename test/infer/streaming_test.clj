...
(deftest enqueueing-state
  ...
  (is (= 15.0 (.getAtLookback q 1)))
  (is (= 15.0 (.getAtIndex q 0)))
  (is (= 2 (.getLength q)))

  (let [_ (.enqueue q 17)]

  (is (= 3. (.getAtLookback q 1)))
  (is (= 17.0 (.getAtLookback q 0)))
  (is (= 15.0 (.getAtLookback q 2)))
  (is (= 3.0 (.getAtIndex q 1)))
  (is (= 3 (.getLength q)))

  (let [_ (.enqueue q 1)]

  (is (= 1.0 (.getAtLookback q 0)))
  (is (= 17.0 (.getAtLookback q 1)))
  (is (= 3.0 (.getAtLookback q 2)))
